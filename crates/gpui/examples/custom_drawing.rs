...
fn basic_shapes_canvas(_colors: &Colors) -> impl IntoElement {
    let error = rgb(0xef4444);
    let success = rgb(0x22c55e);
...
fn custom_paths_canvas(_colors: &Colors) -> impl IntoElement {
    let warning = rgb(0xf59e0b);
    let accent = rgb(0x3b82f6);
...
impl DrawingCanvas {
    ...
    fn get_colors(_colors: &Colors) -> Vec<Rgba> {
        vec![
            rgb(0xef4444),
            rgb(0x22c55e),
            rgb(0x3b82f6),
